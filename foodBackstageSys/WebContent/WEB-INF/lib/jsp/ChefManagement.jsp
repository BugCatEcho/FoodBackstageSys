...
<script src="js/chefjs.js"></script>
</head>
<body>
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">厨师管理界面</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="#">菜品管理 <span class="sr-only">(current)</span></a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false"><c:out value="${chefme.name }" /> <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li class="disabled"><a href="#">更多服务</a><input id="thiscefid" type="hidden" value="${chefme.cid }"/></li>
							<li role="separator" class="divider"></li>
	...
	<div aria-label="...">
		<ul id="pagenum" class="pagination pagination-lg"
			...
			<li><a id="bt_pagenext" aria-hidden="true"  onclick="jumppage(this)">&laquo;</a>
			</li> 
